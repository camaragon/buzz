  ...
  group('System messages', () {
    ...
    testWidgets(
      ...
      (tester) async {
        ...
        final users = _FakeUserCacheNotifier({
        ...
        users.replace(
          const UserProfile(pubkey: 'guest-10', displayName: 'Guest Ten'),
        );
        await tester.pump();
        expect(find.text('Guest Ten'), findsOneWidget);
        transport.emitPeerLeave(24);
        await tester.pump();
        expect(find.text('13 more people'), findsOneWidget);
        expect(
        ...
        await tester.scrollUntilVisible(
          find.byKey(const ValueKey('huddle-participant-roster-row-guest-22')),
          200,
        ...
        await tester.pumpAndSettle();
        for (var peerIndex = 11; peerIndex <= 23; peerIndex++) {
          transport.emitPeerLeave(peerIndex);
        }
        await tester.pumpAndSettle();
        expect(
          find.byKey(const ValueKey('huddle-participant-roster')),
